...
const EXPERTISE_AREAS = [
  {
    ...
    paragraphs: [
      "Oral and Head and Neck cancers can affect the Lips, Tongue, Cheeks, Gums, Floor of the mouth, Jaw, Salivary glands, Throat, Voice box and other structures of the Head and Neck region. They may present as a non-healing ulcer, persistent lump or swelling, difficulty swallowing, hoarseness of voice, or white or red patches in the mouth. Early diagnosis and timely treatment are essential for achieving the best outcomes.",
      "Dr. Arvind provides evidence based surgical management of Oral and Head and Neck Cancers with a focus on complete tumour removal, functional preservation, and quality of life. Each treatment plan is tailored to the patient’s diagnosis, stage of disease, and individual needs.",
    ],
    list: [
      "Early diagnosis and staging through comprehensive clinical evaluation, imaging, and biopsy.",
      "Primary tumour resection using established oncologic principles.",
      "Neck dissection for the management of cervical lymph node disease.",
      "Reconstructive surgery to restore speech, swallowing, appearance, and function.",
      "Multidisciplinary rehabilitation, including speech and swallow therapy.",
      "Long-term surveillance and follow-up for early detection of recurrence and functional recovery.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Benign (non-cancerous) conditions of the Head and Neck include a wide range of swellings and lesions affecting the Oral cavity, Salivary glands, Throat, Voice box and surrounding soft tissues. Although these conditions are not cancerous, they may enlarge over time, cause pain, interfere with function, or result in facial asymmetry if left untreated.",
      "Dr. Arvind offers expert, evidence based surgical management of benign head and neck conditions, with a focus on accurate diagnosis, meticulous surgical planning, and treatment that preserves both function and aesthetics. Every treatment plan is tailored to the patient's diagnosis, symptoms, and individual needs.",
    ],
    list: [
      "Comprehensive clinical evaluation and advanced imaging for accurate diagnosis.",
      "Biopsy when indicated to establish a definitive diagnosis.",
      "Surgical excision of benign soft tissue lesions and tumours.",
      "Management of odontogenic cysts, jaw cysts, and benign jaw tumours.",
      "Minimally invasive surgical techniques whenever appropriate to promote faster recovery and optimal functional outcomes.",
    ],
  },
  {
